...
void main() {
  group('Characters', () {
    group('attributes', () {
      ...
      test('initial ranking is 1', () {
        expect(character.ranking, equals(1));
      });
    ...
    group('serialization', () {
      const jsonString =
          '{"ranking":7,"skills":0,"health":10,"attack":9,"defense":4,"magik":8}';
      test('retrieve correct value from json', () {
        final character = Character.fromJson(jsonString);
        expect(character.ranking, equals(7));
    ...
    group('copyWith', () {
      test('reference current attributes', () {
        ...
        expect(characterA.ranking, equals(characterB.ranking));
      ...
      test('reference new attributes', () {
        ...
        expect(character.ranking, equals(2));
